...
interface TranscriptionSectionProps {
  ...
  setRemoteTranscriptionApiKey: (key: string) => void;
    ...
    <div className="space-y-4">
      ...
      {transcriptionMode === "self-hosted" && (
        <SelfHostedPanel
          ...
          apiKey={remoteTranscriptionApiKey}
          onApiKeyChange={setRemoteTranscriptionApiKey}
        />
      )}
                      ...
                      steps: [
                        ...
                        },
                        {
                          ...
                          desc: t("settingsPage.general.waylandPaste.guide.group.step2Desc", {
                            defaultValue:
                              "Group changes only take effect after a new login session. Log out of your desktop and log back in, then reopen LocalScribe.",
                          }),
                        },
                      ],
                    },
              ...
              <SettingsPanel>
                <SettingsPanelRow>
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    LocalScribe stores notes, history, settings, voice fingerprints, and audio on
                    this device. It has no account sync, analytics, billing, or telemetry service.
                  </p>
                </SettingsPanelRow>
              </SettingsPanel>
            </div>
            ...
            renderDictation={() => (
              <div className="space-y-6">
                <TranscriptionSection
                  ...
                  remoteTranscriptionApiKey={customTranscriptionApiKey}
                  setRemoteTranscriptionApiKey={setCustomTranscriptionApiKey}
