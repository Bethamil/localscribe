#!/usr/bin/env node
// Compiles src/assets/localscribe.icon (Apple Icon Composer bundle) into
...
const ICON_BUNDLE = path.join(__dirname, "..", "src", "assets", "localscribe.icon");
const OUTPUT_CAR = path.join(__dirname, "..", "src", "assets", "Assets.car");
const APP_ICON_NAME = "localscribe";
